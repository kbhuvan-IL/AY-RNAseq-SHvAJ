...
basename=$(sed -n -e "$SLURM_ARRAY_TASK_ID p" basenamesFULL_SP.txt)
...
STAR --runThreadN $SLURM_NTASKS \
     ...
     --genomeDir /home/a-m/kbhuvan2/AY-rnaseq-2024-o/data/reference/STAR-2.7.10a_SAPA_YPS138_v1_allChr_Index \
