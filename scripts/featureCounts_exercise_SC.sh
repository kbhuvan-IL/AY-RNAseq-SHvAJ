...
basename=$(sed -n -e "$SLURM_ARRAY_TASK_ID p" /home/a-m/kbhuvan2/AY-rnaseq-2024-o/src/basenamesFULL_SC.txt)
...
-a /home/a-m/kbhuvan2/AY-rnaseq-2024-o/data/reference/SACE_S288C_v1_allChr_agat.gtf \
-o /home/a-m/kbhuvan2/AY-rnaseq-2024-o/results/featureCounts/${basename}_counts \
/home/a-m/kbhuvan2/AY-rnaseq-2024-o/results/star/${basename}Aligned.sortedByCoord.out.bam
